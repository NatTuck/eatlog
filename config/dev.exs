...
config :eat_log, EatLogWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:eat_log, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:eat_log, ~w(--watch)]}
  ]
...
config :eat_log, EatLogWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/eat_log_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]
